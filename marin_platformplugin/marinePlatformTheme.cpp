...
bool MarinePlatformTheme::usePlatformNativeDialog(DialogType type) const
{
    return m_theme->usePlatformNativeDialog(type);
}

QPlatformDialogHelper *MarinePlatformTheme::createPlatformDialogHelper(DialogType type) const {
...
QVariant MarinePlatformTheme::themeHint(ThemeHint hint) const
{
    switch (hint) {
