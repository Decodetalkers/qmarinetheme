...
//! [0]
void
NorwegianWoodStyle::polish(QPalette &palette)
{
...
//! [3]
void
NorwegianWoodStyle::polish(QWidget *widget)
//! [3] //! [4]
{
...
//! [5]
void
NorwegianWoodStyle::unpolish(QWidget *widget)
//! [5] //! [6]
{
    if (qobject_cast<QPushButton *>(widget) || qobject_cast<QComboBox *>(widget))
...
//! [7]
int
NorwegianWoodStyle::pixelMetric(PixelMetric metric,
                                //! [7] //! [8]
...
//! [9]
int
NorwegianWoodStyle::styleHint(StyleHint hint,
                              const QStyleOption *option,
                              //! [9] //! [10]
                                  ...
                                  const QWidget *widget) const
{
    ...
    case PE_PanelButtonCommand: {
        ...
        QPolygon topHalf;
        topHalf << QPoint(x1, y) << QPoint(x4, y) << QPoint(x3, y + radius)
...
//! [35]
void
NorwegianWoodStyle::drawControl(ControlElement element,
                                //! [35] //! [36]
                                const QStyleOption *option,
                                QPainter *painter,
                                const QWidget *widget) const
...
//! [37]
void
NorwegianWoodStyle::setTexture(QPalette &palette,
...
//! [39]
QPainterPath
NorwegianWoodStyle::roundRectPath(const QRect &rect)
//! [39] //! [40]
{
